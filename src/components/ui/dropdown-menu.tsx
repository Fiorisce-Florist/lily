...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "text-b5 font-inter flex cursor-default items-center rounded-lg px-2 py-1.5 outline-none select-none",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn("text-b5 font-inter px-2 py-1.5 font-semibold", inset && "pl-8", className)}
    {...props}
  />
));
...
type DropdownMenuTriggerProps = React.ComponentPropsWithoutRef<typeof DropdownMenuTrigger>;
type DropdownMenuGroupProps = React.ComponentPropsWithoutRef<typeof DropdownMenuGroup>;
type DropdownMenuPortalProps = React.ComponentPropsWithoutRef<typeof DropdownMenuPortal>;
type DropdownMenuSubProps = React.ComponentPropsWithoutRef<typeof DropdownMenuSub>;
type DropdownMenuRadioGroupProps = React.ComponentPropsWithoutRef<typeof DropdownMenuRadioGroup>;
type DropdownMenuSubTriggerProps = React.ComponentPropsWithoutRef<typeof DropdownMenuSubTrigger>;
type DropdownMenuSubContentProps = React.ComponentPropsWithoutRef<typeof DropdownMenuSubContent>;
...
>;
type DropdownMenuRadioItemProps = React.ComponentPropsWithoutRef<typeof DropdownMenuRadioItem>;
type DropdownMenuLabelProps = React.ComponentPropsWithoutRef<typeof DropdownMenuLabel>;
type DropdownMenuSeparatorProps = React.ComponentPropsWithoutRef<typeof DropdownMenuSeparator>;
