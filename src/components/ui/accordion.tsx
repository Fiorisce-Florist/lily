  ...
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ...
      className={cn(
        ...
        "text-b4 font-inter hover:text-camel-600 dark:hover:text-camel-400 focus-visible:ring-camel-500 dark:focus-visible:ring-offset-neutral-1000 [&[data-state=open]>svg]:text-camel-600 dark:data-[state=open]:text-camel-400 data-[state=open]:text-camel-600 dark:[&[data-state=open]>svg]:text-camel-400 flex flex-1 items-center justify-between rounded-md py-4 font-medium text-neutral-900 transition-all duration-200 focus-visible:ring-1 focus-visible:ring-offset-2 focus-visible:outline-hidden dark:text-neutral-100 [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
