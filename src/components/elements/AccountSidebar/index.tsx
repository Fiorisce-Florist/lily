  ...
  return (
    <div className="flex flex-col space-y-1 md:sticky md:top-24">
      ...
      <nav className="flex md:flex-col gap-2 overflow-x-auto md:overflow-visible pb-4 md:pb-0 px-4 md:px-0 scrollbar-hide">
        ...
        <button
          className="flex items-center gap-3 px-4 py-3 rounded-xl font-inter text-b3 font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors text-left"
        >
