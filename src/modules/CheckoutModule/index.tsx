    ...
    <div className="min-h-screen bg-cornsilk-50 dark:bg-neutral-950 pb-20">
      ...
      <header className="border-b border-cornsilk-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 sticky top-0 z-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link href="/cart" className="flex items-center gap-2 text-b4 font-inter text-neutral-600 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-cornsilk-100 transition-colors">
            ...
            <section className="bg-white dark:bg-neutral-900 rounded-3xl p-6 sm:p-8 border border-cornsilk-200 dark:border-neutral-800 shadow-sm">
              ...
              <RadioGroup defaultValue="credit-card" className="space-y-4">
                ...
                <div className="flex items-center space-x-2 border border-cornsilk-200 dark:border-neutral-800 p-4 rounded-2xl hover:bg-cornsilk-50 dark:hover:bg-neutral-800/50 transition-colors">
                  ...
                  <Label htmlFor="credit-card" className="flex flex-1 items-center justify-between cursor-pointer pl-2">
                    <span className="font-inter font-medium text-neutral-900 dark:text-cornsilk-100">Credit Card</span>
                ...
                <div className="flex items-center space-x-2 border border-cornsilk-200 dark:border-neutral-800 p-4 rounded-2xl hover:bg-cornsilk-50 dark:hover:bg-neutral-800/50 transition-colors">
                  ...
                  <Label htmlFor="bank-transfer" className="flex flex-1 items-center justify-between cursor-pointer pl-2">
                    <span className="font-inter font-medium text-neutral-900 dark:text-cornsilk-100">Bank Transfer</span>
                ...
                <div className="flex items-center space-x-2 border border-cornsilk-200 dark:border-neutral-800 p-4 rounded-2xl hover:bg-cornsilk-50 dark:hover:bg-neutral-800/50 transition-colors">
                  ...
                  <Label htmlFor="qr" className="flex flex-1 items-center justify-between cursor-pointer pl-2">
                    <span className="font-inter font-medium text-neutral-900 dark:text-cornsilk-100">QRIS / E-Wallet</span>
            ...
            <div className="rounded-3xl border border-cornsilk-200 bg-white dark:border-neutral-800 dark:bg-neutral-900 overflow-hidden shadow-sm sticky top-24">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-b5 font-inter text-neutral-600 dark:text-neutral-400">Subtotal</span>
                  <span className="text-b5 font-jetbrains font-medium text-neutral-800 dark:text-cornsilk-100">{formatPrice(1550000)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-b5 font-inter text-neutral-600 dark:text-neutral-400">Shipping</span>
                  <span className="text-b5 font-jetbrains font-medium text-olive-700 dark:text-olive-400">Free</span>
                </div>
                
                <Separator className="my-4" />
                
                <div className="flex justify-between items-center">
                  <span className="text-h4 font-fraunces font-semibold text-neutral-900 dark:text-cornsilk-100">Total</span>
                  <span className="text-h4 font-jetbrains font-bold text-neutral-900 dark:text-cornsilk-100">{formatPrice(MOCK_TOTAL)}</span>
                </div>
