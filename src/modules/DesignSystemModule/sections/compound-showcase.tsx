            ...
            <Card>
              ...
              <CardContent>
                <p className="text-b4 text-neutral-700">
                  Our seasonal bouquets are carefully curated and arranged by expert florists using
                  the freshest blooms available.
                </p>
              </CardContent>
        ...
        <div className="space-y-4">
          ...
          <div className="border-cornsilk-300 space-y-4 rounded-xl border bg-white p-6 dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <Alert variant="success">
              ...
              <AlertDescription>Your order has been successfully placed.</AlertDescription>
            </Alert>
            <Alert variant="warning">
              <Info className="h-4 w-4" />
              <AlertTitle>Warning</AlertTitle>
              <AlertDescription>Your subscription is about to expire in 3 days.</AlertDescription>
            </Alert>
          </div>
        </div>
          ...
          <div className="border-cornsilk-300 max-w-xl rounded-xl border bg-white p-6 dark:border-neutral-800 dark:bg-neutral-900">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  Depending on your subscription plan, we deliver either weekly, bi-weekly, or
                  monthly.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent>
                  We focus on seasonal, locally sourced flowers to ensure maximum freshness and
                  sustainability.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
        ...
        <div className="space-y-4">
          ...
          <div className="border-cornsilk-300 rounded-xl border bg-white p-6 dark:border-neutral-800 dark:bg-neutral-900">
            <ScrollArea className="border-cornsilk-400 h-72 w-48 rounded-md border dark:border-neutral-800">
              <div className="p-4">
                <h4 className="text-b4 font-inter mb-4 leading-none font-medium">Tags</h4>
