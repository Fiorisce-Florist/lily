    ...
    <section className="space-y-8">
      <div>
        ...
        <p className="text-b4 mb-8 max-w-2xl text-neutral-600 dark:text-neutral-400">
          The Lily design system uses three typefaces: Fraunces (display), Inter
          (body), and JetBrains Mono (monospace).
        </p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="border-cornsilk-300 space-y-6 rounded-xl border bg-white p-6 dark:border-neutral-800 dark:bg-neutral-900">
            <div className="flex flex-col gap-1">
              <span className="text-b5 font-jetbrains text-neutral-400">
                text-h1 (39px)
              </span>
        ...
        <div className="space-y-4">
          ...
          <div className="border-cornsilk-300 space-y-6 rounded-xl border bg-white p-6 dark:border-neutral-800 dark:bg-neutral-900">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-m1 font-jetbrains text-neutral-700 dark:text-neutral-300">
                ROSE
              </p>
            </div>
            <div className="flex flex-col gap-1">
              ...
              <p className="text-m2 font-jetbrains text-neutral-700 dark:text-neutral-300">
                ROSE
              </p>
            </div>
            <div className="flex flex-col gap-1">
              ...
              <p className="text-m3 font-jetbrains text-neutral-700 dark:text-neutral-300">
                ROSE
              </p>
            </div>
          </div>
