      ...
      <div className="space-y-12">
        {palettes.map((palette) => (
          <div key={palette.name} className="space-y-4">
            <div>
              <h3 className="text-h4 font-fraunces dark:text-cornsilk-100 font-semibold text-neutral-900">
                {palette.name}
              </h3>
              ...
              {steps.map((step) => {
                ...
                return (
                  <div key={step}>
                    <div
                      className={cn(
                        "font-jetbrains text-m3 flex h-16 items-center justify-center rounded-lg border border-neutral-200/20 font-medium",
                        className,
                        step > 600 ? "text-white" : "text-neutral-900"
                      )}
                    >
                      {step}
                    </div>
