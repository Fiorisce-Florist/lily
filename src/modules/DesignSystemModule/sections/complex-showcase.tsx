...
const columns: ColumnDef<Payment>[] = [
  ...
  { accessorKey: "email", header: "Email" },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className="font-medium text-right font-jetbrains">{formatted}</div>
    },
  },
]
              ...
              <CarouselContent>
                {Array.from({ length: 5 }).map((_, index) => (
                  <CarouselItem key={index}>
                    <div className="p-1">
                      <div className="flex aspect-square items-center justify-center rounded-xl bg-cornsilk-200 border border-cornsilk-400">
