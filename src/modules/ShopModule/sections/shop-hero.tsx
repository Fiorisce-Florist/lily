...
const SUGGESTIONS = ["Roses", "Wedding", "Birthday", "Sunflower", "Peony"] as const;
      ...
      <div className="relative container mx-auto px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h1 className="text-h1 font-fraunces font-bold text-neutral-900 dark:text-cornsilk-100">
            {dictionary.shopPage.hero.titlePrefix}
            <span className="relative ml-3 inline-block">
              <span className="relative z-10 text-blush-600 dark:text-blush-400">
                {dictionary.shopPage.hero.titleAccent}
              </span>
              <span
                aria-hidden
          ...
          <p className="text-b4 mt-4 text-neutral-600 dark:text-neutral-400">
            {dictionary.shopPage.hero.subtitle}
          </p>
          ...
          <div className="relative mt-8 mx-auto max-w-xl">
            ...
            <Input
              id="shop-search"
              type="search"
              placeholder={dictionary.shopPage.hero.placeholder}
              value={query}
              ...
              aria-label={dictionary.shopPage.hero.ariaLabel}
            />
          </div>
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-2">
            {SUGGESTIONS.map((s) => (
              ...
              >
                {dictionary.shopPage.hero.suggestions[s]}
              </button>
            ))}
            {query && (
              <button
